...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddContaSuiteData(this IServiceCollection services, string rutaArchivoSqlite)
    {
        services.AddDbContextFactory<ContaSuiteDbContext>(opciones => opciones.UseSqlite($"Data Source={rutaArchivoSqlite}"));
